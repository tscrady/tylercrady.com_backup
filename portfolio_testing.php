...
if(isset($_GET['portfolio']) ){
        ...
        if($portfolio_object->isPortfolio($_GET['portfolio'])){
            $portfolio_object->current_portfolio = $_GET['portfolio'];// set the album name
            $portfolio_object->get_portfolio_info();
            $access = $portfolio_object->access;
            if($access == "open"){
                $oktoshow = true;
            }
...
//If there is an portfolio to show, lets show it
    if(isset($_GET['portfolio']) && $portfolio_object->is_portfolio($_GET['portfolio'])){
        ...
        $date           = date('F Y', strtotime($current_portfolio['date']));
